...
export const irregularCave: MapConfig = {
  ...
  spells: [
    ...
    'Cave Burp — everyone laughs, you heal one life',
  ],
  combat: [
    'You swing wild — bonk a stalactite, it drops on the enemy. Both of you take a wound; remove the mini',
    'Solid whack right on the nose — enemy keels over, remove the mini',
    'Solid whack — enemy is stunned and starry-eyed, joins you as a companion',
    'You offer it your snack — enemy is charmed, joins you as a companion',
    'Pocket sand! Enemy stumbles into the wall and conks out, remove the mini',
    'Critical hit — enemy puffs into smoke, remove the mini',
  ],
  enemy: [
    'Poos pants — falls over backwards, sits in it, glares',
    'Wild swing — you take a wound',
    'Glares so hard your hair stands up — spooky, no effect',
    'Stomps in place — no effect, but loud',
    'Yells for its mum — another tiny enemy appears now on the entrance tile',
    'Shrugs it off — nothing happens',
  ],
  events: [
    'A wet drip in the dark — nothing else happens',
    'Distant rumble — the cave groans, dust falls',
    'A bat flaps past your face — flinch, take a wound on a sharp rock',
